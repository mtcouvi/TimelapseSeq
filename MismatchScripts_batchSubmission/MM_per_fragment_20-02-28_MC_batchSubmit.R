...
# set wd
#setwd("/Users/bsmalec/Dropbox (HMS)/PhD/Sequencing_data/2019-11-10_B_libs/halfLives")
...
library(tidyr, lib.loc="~/R-4.0.1/library/")
#library(tidyr)
#library(dplyr)
#install.packages("splitstackshape")
library(splitstackshape, lib.loc="~/R-4.0.1/library/")
